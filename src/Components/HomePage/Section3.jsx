  ...
  return (
      ...
      >
         <div className='relative py-20 px-1 md:py-0 md:px-0'>
            <div className='border space-y-3 border-white text-white top-0 md:absolute md:left-[40%] lg:left-[40%] md:top-30 font-serif p-10 bg-[#000000]/70 md:w-[400px] lg:w-[600px]'>
               ...
               <button className='animated-hover-button py-3 px-8 rounded-sm cursor-pointer'>
                  <a href="/">
                     ORDER NOW
                  </a>
               </button>
